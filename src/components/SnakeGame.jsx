  ...
  return (
    <div className="glass-panel">
      <div className="game-hud">
        <button className="btn btn-secondary" style={{ width: 'auto', padding: '8px' }} onClick={onBack}>
          <ArrowLeft size={20} />
        </button>
      ...
      <div className="game-canvas-container">
          ...
          <defs>
            ...
            <g id="Aletas" transform="matrix(1, 0, 0, 1, 0, 0)">
              <linearGradient id="LinearGradID_1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(0.0935974, 0, 0, 0.188782, -20.55, 0)" spreadMethod="pad" x1="-819.2" y1="0" x2="819.2" y2="0">
                <stop offset="0" style={{stopColor: '#99cc00', stopOpacity: 1}} />
                <stop offset="1" style={{stopColor: '#0a0a0a', stopOpacity: 1}} />
              </linearGradient>
            ...
            <g id="Espina" transform="matrix(1, 0, 0, 1, 0, 0)">
              <linearGradient id="LinearGradID_2" gradientUnits="userSpaceOnUse" gradientTransform="matrix(0.0229492, 0, 0, -0.0152893, 0, 0.05)" spreadMethod="pad" x1="-819.2" y1="0" x2="819.2" y2="0">
                <stop offset="0" style={{stopColor: '#99cc00', stopOpacity: 1}} />
                <stop offset="1" style={{stopColor: '#050505', stopOpacity: 1}} />
              </linearGradient>
        ...
        {gameState === 'gameover' && (
          <div className="overlay" style={{ zIndex: 10 }}>
            <h2>Game Over!</h2>
            <p style={{ marginBottom: '1.5rem', fontSize: '1.2rem' }}>Final Score: {score}</p>
            <div style={{ display: 'flex', gap: '10px' }}>
              <button className="btn" onClick={resetGame} style={{ width: 'auto' }}>
                Play Again
              </button>
              <button className="btn btn-secondary" onClick={onBack} style={{ width: 'auto' }}>
                Main Menu
              </button>
            </div>
          </div>
